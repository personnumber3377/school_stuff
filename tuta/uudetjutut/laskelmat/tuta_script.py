...
Ensimmäisistä sopimusneuvotteluista palattuaan Biohajotus Oy:n myyntiedustaja toteaa, että tämänhetkisten sopimusehdotusten toteutuessa tyypillisen toimintavuoden luvut näyttäisivät seuraavanlaisilta: asiakkaille toimitettu tynnyrimäärä on 1350 kpl, myyntihinta on 700 €/kpl, myyntikatetuottoprosentti 71 %, ja liiketoiminnan muut kustannukset 322000 €.
...
def calcs():
	...
	asiakkaille_toimitetut_tynnyrit = 1350 # kpl
	myyntihinta_per_kappale = 700 # €/kpl

	myyntikatetuottoprosentti = 0.71 # 75 %

	muut_kustannukset = 322000 # euros

	prosenttimuutos = 0.08 # Tämä on muutos hinnassa tehtävässä 5!!!!

	myyntiedustajan_palkka_vuodessa = 52000
