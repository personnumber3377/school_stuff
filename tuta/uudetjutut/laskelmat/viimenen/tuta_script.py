...
Ensimmäisistä sopimusneuvotteluista palattuaan Biohajotus Oy:n myyntiedustaja toteaa, että tämänhetkisten sopimusehdotusten toteutuessa tyypillisen toimintavuoden luvut näyttäisivät seuraavanlaisilta: asiakkaille toimitettu tynnyrimäärä on 1390 kpl, myyntihinta on 700 €/kpl, myyntikatetuottoprosentti 72 %, ja liiketoiminnan muut kustannukset 323000 €.
...
def calcs():
	...
	asiakkaille_toimitetut_tynnyrit = 1390 # kpl
	myyntihinta_per_kappale = 700 # €/kpl

	myyntikatetuottoprosentti = 0.72 # 75 %

	muut_kustannukset = 323000 # euros

	prosenttimuutos = 0.07 # Tämä on muutos hinnassa tehtävässä 5!!!!

	myyntiedustajan_palkka_vuodessa = 47000
