...
from plagiarized import * # Import all of the bullshit from the other file...
...
if __name__=="__main__":
	...
	spline_x_stuff = calc_spline_params(np.array(t_i), np.array(x_knots)) # Here is the bullshit
	spline_y_stuff = calc_spline_params(np.array(t_i), np.array(y_knots))
	# print("Other bullshit")
	# print(other_bullshit)
